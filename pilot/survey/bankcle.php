	...
	<body>
		<nav class="navbar navbar-default navbar-static-top" role="navigation">
			<div class="navbar-header">
				<a class="navbar-brand brand-center">Bank - Central Line Escalators</a>
			</div>
		</nav>
		...
		<div class="container">
			...
			<div class="row" style="vertical-align:middle;margin-bottom:15px">
				<div class="col-sm-6 form-inline" style="text-align:left;">
					<div class="form-group">
					<label><strong>Have you been involved in resolving issues concerning the Central Line Escalators (including in relation to impacts on settlements, and agreement on UMC/LMC, switchgear and maintenance spaceproofing requirements)?</strong></label>
			...
			<div id="tableinst" class="row" style="vertical-align:middle;margin-bottom:20px">
				<div class="col-sm-12 form-inline" style="text-align:left;">
					<label>The aim of the following table is to capture who you communicate with to resolve issues concerning the Central Line Escalators.
