...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="./banktp.css">
		<script type="text/javascript" src="./banktp.js"></script>
	</head>
	<body>
		<nav class="navbar navbar-default navbar-static-top" role="navigation">
			<div class="navbar-header">
				<a class="navbar-brand brand-center">Bank - Transformer Protection & Switchgear Relocation</a>
			</div>
		</nav>
		...
		<div class="container">
			...
			<div class="row" style="vertical-align:middle;margin-bottom:15px">
				<div class="col-sm-6 form-inline" style="text-align:left;">
					<div class="form-group">
					<label><strong>Have you been involved in resolving issues concerning the Central Line link transformer protection and switchgear relocation?</strong></label>
			...
			<div id="tableinst" class="row" style="vertical-align:middle;margin-bottom:20px">
				<div class="col-sm-12 form-inline" style="text-align:left;">
					<label>The aim of the following table is to capture who you communicate with to resolve issues concerning he Central Line link transformer protection and switchgear relocation.
