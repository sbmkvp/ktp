	...
	<div id="ana">
		<div id="gen" class="card">
			<div class="card-header">
				<div class="card-heading">General Information 
					<span class="glyphicon glyphicon-chevron-down grey right"></span>
				</div>
			</div>
			<div class="card-content">
				...
				<div id="degreedist" style="width:50%;height:250px;margin-bottom:15px;"></div>
